        ...
        <pane size="84">
          <el-col>
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
             ...
             <el-table-column label="金币数量" align="center" key="coin" prop="coin" v-if="columns.coin.visible" width="120" />
        ...
        <el-row>
          <el-col :span="11">
            <el-form-item label="金币">
              <el-input v-model="form.coin" type="text" placeholder="请输入金币"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
